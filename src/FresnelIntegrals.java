/**
 * a small repo to approximate fresnel integrals to a high degree of precision quickly
 *
 * https://www.desmos.com/calculator/azle1ncfmx
 *
...
public class FresnelIntegrals {
    ...
    private static double taylorC(double x){
        double out = 0;
    ...
    private static double approxS(double x){
        double out = 0.015467;
        double PI = Math.PI;
    ...
    private static double approxC(double x){
        double out = 0.01146;
        double PI = Math.PI;
        double halfPI = PI/2;
        double squareX = x*x;
    ...
    public static double S(double x){
        ...
        return approxS(x*polarity)*polarity;
    }
    ...
    public static double C(double x){
        ...
        return approxC(x*polarity)*polarity;
    }
}
